...
import ch.gwinn.pos.data.StripeTokenProvider
import ch.gwinn.pos.databinding.ActivityPaymentBinding
import ch.gwinn.pos.logic.Money
import ch.gwinn.pos.viewmodel.PaymentState
import ch.gwinn.pos.viewmodel.PaymentViewModel
import ch.gwinn.pos.viewmodel.PaymentViewModelFactory
import coil.load
...
class PaymentActivity : AppCompatActivity() {
    ...
    // gwinn multi-tenant: no baked-in location. If the store has none yet,
        ...
        lifecycleScope.launch {
            try {
                val res = RetrofitClient.apiService.provisionLocation(
                    ch.gwinn.pos.data.models.LocationProvisionRequest(
                        displayName = "Gwinn POS",
                        address = ch.gwinn.pos.data.models.LocationProvisionRequest.Address(
