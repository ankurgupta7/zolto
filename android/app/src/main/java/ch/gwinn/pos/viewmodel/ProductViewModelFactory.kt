...
import ch.gwinn.pos.data.SharedPrefsViewModeStore
import ch.gwinn.pos.data.ViewModeStore

class ProductViewModelFactory(
    private val api: ApiService,
    private val productDao: ch.gwinn.pos.data.local.ProductDao,
...
class SalesHistoryViewModelFactory(
    private val api: ApiService,
    private val salesDao: ch.gwinn.pos.data.local.SalesDao,
) : ViewModelProvider.Factory {
    override fun <T : ViewModel> create(modelClass: Class<T>): T {
        @Suppress("UNCHECKED_CAST")
