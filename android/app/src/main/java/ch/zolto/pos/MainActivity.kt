...
import ch.zolto.pos.databinding.ActivityMainBinding
import ch.zolto.pos.logic.CategoryLogic
import ch.zolto.pos.logic.Money
import ch.zolto.pos.ui.ProductGridAdapter
import ch.zolto.pos.ui.ProductSectionedAdapter
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (!ch.zolto.pos.data.PosConfig.isConfigured(this)) {
            startActivity(android.content.Intent(this, SetupActivity::class.java))
            finish()
            return
        }
        RetrofitClient.init(
            ch.zolto.pos.data.PosConfig.baseUrl(this)!!,
            ch.zolto.pos.data.PosConfig.apiKey(this)!!,
        )
