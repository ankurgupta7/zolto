...
import ch.zolto.pos.databinding.ActivitySaleReviewBinding
import ch.zolto.pos.logic.Money
import ch.zolto.pos.ui.CustomItemAdapter
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        productViewModel = ViewModelProvider(
            ...
            ProductViewModelFactory(
                ...
                ch.zolto.pos.data.local.DatabaseClient.getInstance(this).productDao(),
            ),
