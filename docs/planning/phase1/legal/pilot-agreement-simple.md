...
> *and* the AI-photo disclosure specifically. Draft — review before sending.
...
reused in new material after that.
...
*Full version with distribution-channel checkboxes, sensitive-data
handling, and representations/warranties: see `content-release-form.md` in
this folder — use that one if a more detailed version is ever needed.*
