          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 max-w-5xl mx-auto">
            ...
            <div>
              ...
              <div className="mt-12 p-6 border border-[var(--brand-accent)]/20 bg-[var(--brand-surface)]">
                <div className="text-[var(--brand-accent)] text-xl font-serif mb-3">
                  ◇
                </div>
            ...
            <div>
              {submitted ? (
                <div className="flex flex-col items-center justify-center h-full text-center py-16">
                  <div className="text-5xl text-[var(--brand-accent)] font-serif mb-6">
                    ✦
                  </div>
                  ...
                  <div>
                    ...
                    >
                      ...
                      <option value="product">
                        {t("contact.subjectProduct")}
                      </option>
                      <option value="bespoke">
                        {t("contact.subjectBespoke")}
                      </option>
