              ...
              <div className="space-y-6">
                ...
                <div>
                  ...
                  >
                    ...
                    <div>
                      <p className="text-sm font-sans font-medium text-foreground group-hover:text-white transition-colors">@kalakoshzurich</p>
                      <p className="text-xs text-muted-foreground group-hover:text-white/80 transition-colors font-sans">{t("contact.followCaption")}</p>
                    </div>
                  </a>
                </div>
                <div>
