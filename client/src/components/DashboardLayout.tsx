  ...
  return (
    <>
      <div className="relative" ref={sidebarRef}>
        ...
        {/* Pointer-only drag affordance to resize the sidebar. There is no
            meaningful keyboard equivalent for free-drag resizing; keyboard users
            collapse/expand via the SidebarTrigger toggle instead. */}
        {/* biome-ignore lint/a11y/noStaticElementInteractions: pointer-only resize handle; keyboard users use the collapse toggle */}
        <div
