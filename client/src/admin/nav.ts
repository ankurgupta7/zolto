...
export const ADMIN_NAV: AdminNavItem[] = [
  ...
  { id: "domain", plane: "store", label: "Domain", icon: "Globe", path: "/admin/domain", requiredPlan: "maker" },
  ...
  { id: "insights", plane: "store", label: "Insights", icon: "BarChart3", path: "/admin/insights", requiredPlan: "studio" },
  ...
  { id: "credits", plane: "account", label: "AI credits", icon: "Sparkles", path: "/admin/account/credits", requiredRole: "admin" },
